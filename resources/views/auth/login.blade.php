    ...
    <div class="row g-0 app-auth-wrapper">
	    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
		    <div class="d-flex flex-column align-content-end">
			    <div class="app-auth-body mx-auto">	<br><br>
				    <div class="app-auth-branding mb-4"><a class="app-logo" href="#"><img  src="{{ asset('assets/images/logo-musedm_1.png') }}" alt="logo"></a></div>
			        ...
			        <div class="auth-form-container text-start">
						...
						<div class="auth-option text-center pt-5">Sem conta? Inscreva-se <a class="text-link" href="{{ route('signup') }}" >Aqui</a>.</div>
		    ...
		    <div class="auth-background-overlay p-3 p-lg-5">
			    <div class="d-flex flex-column align-content-end h-100">
				    ...
				    <div class="overlay-content p-3 p-lg-4 rounded">
					    ...
					    <div>Portal is a free Bootstrap 5 admin dashboard template. You can download and view the template license >here</a>.</div>
				    </div>
				</div>
